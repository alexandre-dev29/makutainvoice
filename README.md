...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/6QaxcoRmYr)
...
```sh
npx nx serve makutainv
```

To create a production bundle:

```sh
npx nx build makutainv
```

To see all available targets to run for a project, run:

```sh
npx nx show project makutainv
```
